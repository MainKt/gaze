defmodule GazeWeb.ChatLive do
  ...
  def render(assigns) do
    ...
    <div class="flex">
      ...
      <.chat_section channel={(@channels |> Enum.find(& &1.selected)).name}>
        <.messages>
          <.message online={true} text="How are y'all doing?" user="Main.kt" time="5:30" compact={true} />
  ...
  def message(assigns) do
    ...
    <div class="relative flex gap-2 hover:bg-gray-100 px-4 pt-2 group">
      <.user_profile user={@user} size={:md} class="mt-1" online={@online} display_color={@display_color}/>
      <div class="flex-1">
